...
const handlePasswordChange = (e) =>{
 ...
 const handleSubmit = () => {
      if( useLogin === "admin" && password === "admin" ){
        navigate ("/projects" )
      } else{
                               ...
                               <div className="mt-8">
                                <form >
                                    <div>
                                        ...
                                        <input onChange={handleLoginChange} type="text" name="login" value={useLogin} id="login" placeholder="Логин"
                                    ...
                                    <div className="mt-6">
                                        <div className="flex justify-between mb-2">
                                          ...
                                          <input onChange={handlePasswordChange} type="password" name="password" id="password" value={password} placeholder="Пароль"
                                               className="block w-full px-4 py-2 mt-2 text-b-700 placeholder-Fuchsia-400 bg-white border rounded-none border-gray-200 hover:border-fuchsia-500 focus:outline-red-300 rounded-none"/>
                                    </div>
